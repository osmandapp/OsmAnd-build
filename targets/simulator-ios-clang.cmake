...
set(CMAKE_COMPILER_C_FLAGS "-isysroot ${SDK_ROOT} -arch i386 -stdlib=libc++ -mios-simulator-version-min=5.0")
set(CMAKE_COMPILER_CXX_FLAGS "-isysroot ${SDK_ROOT} -arch i386 -std=c++11 -stdlib=libc++ -mios-simulator-version-min=5.0")
