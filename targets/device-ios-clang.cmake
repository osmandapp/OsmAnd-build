...
execute_process(COMMAND xcodebuild -sdk iphoneos -find-executable clang OUTPUT_VARIABLE _CLANG_PATH)
string(STRIP "${_CLANG_PATH}" _CMAKE_C_COMPILER)
message(WARNING "${_CMAKE_C_COMPILER}")
set(CMAKE_C_COMPILER ${_CMAKE_C_COMPILER})
execute_process(COMMAND xcodebuild -sdk iphoneos -find-executable clang++ OUTPUT_VARIABLE _CLANGPP_PATH)
string(STRIP "${_CLANGPP_PATH}" _CMAKE_CXX_COMPILER)
message(WARNING "${_CMAKE_CXX_COMPILER}")
