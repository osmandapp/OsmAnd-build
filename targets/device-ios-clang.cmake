...
set(CMAKE_COMPILER_C_FLAGS "-isysroot ${SDK_ROOT} -arch armv7 -arch armv7s -stdlib=libc++ -miphoneos-version-min=5.0")
set(CMAKE_COMPILER_CXX_FLAGS "-isysroot ${SDK_ROOT} -arch armv7 -arch armv7s -std=c++11 -stdlib=libc++ -miphoneos-version-min=5.0")
